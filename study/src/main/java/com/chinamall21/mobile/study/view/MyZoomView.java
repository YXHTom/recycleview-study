...
/**
 * desc：
 * author：Created by xusong on 2018/9/7 14:50.
 */


public class MyZoomView extends ImageView implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public MyZoomView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        Log.e(TAG,"君甚咸，此鱼何能及君也？");
        LogUtils.LogE("scale = " + scale + "scaleFactor =" + scaleFactor);
